        ...
        <div class="bg-white shadow-lg rounded-xl p-6 sm:p-8">
            <?php if ($totalItems): ?>
                <ul id="quizResultList" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    <?php 
                        $today = date('Y-m-d');
                        foreach ($paginatedQuizResults as $attempt): 
...
<!-- Pagination Controls -->
                ...
                <div class="mt-6 flex flex-col items-center">
                    ...
                    <div class="text-sm text-gray-600 mb-3">
                        ...
                        <span><?php echo $totalItems; ?> total results</span>
                    </div>
                    <!-- Pagination Controls -->
                    <nav class="inline-flex rounded-xl shadow-sm overflow-hidden" aria-label="Pagination">
                        ...
                        <?php if ($page > 1): ?>
                            <a href="?page=<?php echo $page - 1; ?>"
                               class="relative inline-flex items-center px-4 py-2.5 border-r border-gray-200 bg-white text-sm font-medium text-gray-700 hover:bg-green-50 hover:text-green-700 transition-colors duration-150 ease-in-out">
                        ...
                        <div class="hidden md:flex">
                            ...
                            if ($startPage > 1): ?>
                                <a href="?page=1" class="relative inline-flex items-center px-4 py-2.5 border-r border-gray-200 bg-white text-sm font-medium text-gray-700 hover:bg-green-50 hover:text-green-700 transition-colors">
                                    1
                                </a>
                                <?php if ($startPage > 2): ?>
                            ...
                            <?php for ($i = $startPage; $i <= $endPage; $i++): ?>
                                <?php if ($i == $page): ?>
                                    <span class="relative inline-flex items-center px-4 py-2.5 border-r border-gray-200 bg-green-100 text-sm font-bold text-green-700">
                                        <?php echo $i; ?>
                                    </span>
                                <?php else: ?>
                                    <a href="?page=<?php echo $i; ?>" class="relative inline-flex items-center px-4 py-2.5 border-r border-gray-200 bg-white text-sm font-medium text-gray-700 hover:bg-green-50 hover:text-green-700 transition-colors">
                                        <?php echo $i; ?>
                                    </a>
                                <?php endif; ?>
                            <?php endfor; ?>
                            ...
                            <?php if ($endPage < $totalPages): ?>
                                ...
                                <?php endif; ?>
                                <a href="?page=<?php echo $totalPages; ?>" class="relative inline-flex items-center px-4 py-2.5 border-r border-gray-200 bg-white text-sm font-medium text-gray-700 hover:bg-green-50 hover:text-green-700 transition-colors">
                                    <?php echo $totalPages; ?>
                                </a>
                            <?php endif; ?>
                        </div>
                        ...
                        <?php if ($page < $totalPages): ?>
                            <a href="?page=<?php echo $page + 1; ?>"
                               class="relative inline-flex items-center px-4 py-2.5 bg-white text-sm font-medium text-gray-700 hover:bg-green-50 hover:text-green-700 transition-colors duration-150 ease-in-out">
                                <span>Next</span>

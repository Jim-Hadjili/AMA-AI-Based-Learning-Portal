...
<body class="bg-gray-100 min-h-screen">
    ...
    <div id="main-content" class="min-h-screen">
        ...
        <main class="p-4 lg:p-6 pt-6">
            ...
            <?php include "../Includes/attemptsQuizResultIncludes/attemptsAnswerSheetBreadcrumb.php" ?>

            <!-- Answer Sheet Header -->
            <?php include "../Includes/attemptsQuizResultIncludes/attemptsAnswerSheetHeader.php" ?>

            <!-- Detailed Answer Review -->
            <?php include "../Includes/attemptsQuizResultIncludes/attemptsQuizResultReviewSection.php" ?>

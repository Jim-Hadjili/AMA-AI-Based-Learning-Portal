        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2">        
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="quizResult.php?attempt_id=<?php echo htmlspecialchars($attempt_id); ?>" class="bg-white hover:bg-gray-50 text-gray-700 px-4 py-2.5 rounded-xl flex items-center text-sm font-medium transition-all duration-200 shadow-sm hover:shadow-md border border-gray-400/50 quiz-navigation-link">
                        Quiz Results
                    </a>
                </div>
            </li>

...
(199, 112, 'ST202507239872', '2025-08-03 09:20:17', NULL, 0, 'failed', 'completed', 'Jim Hadjili', 'jim.hadjili@gmail.com', 'grade_12', 'stem', '12345', 'TC202507225654', 'English Quiz — Basic Grammar & Vocabulary', NULL, 'manual');
...
(674, 199, 172, '123', NULL, 0, 0, '2025-08-03 15:20:17'),
(675, 199, 173, '127', NULL, 0, 0, '2025-08-03 15:20:17');
...
--
ALTER TABLE `question_options_tb`
  MODIFY `option_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=439;

--
-- AUTO_INCREMENT for table `quizzes_tb`
--
ALTER TABLE `quizzes_tb`
  MODIFY `quiz_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=140;
...
--
ALTER TABLE `quiz_questions_tb`
  MODIFY `question_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=288;
...
--
ALTER TABLE `student_answers_tb`
  MODIFY `answer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=676;

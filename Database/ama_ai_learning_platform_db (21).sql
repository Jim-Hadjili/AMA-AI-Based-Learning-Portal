...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 02, 2025 at 12:19 PM
...
(129, 173, 'Wrote', 1, 3),
(130, 173, 'Writing', 0, 4),
(355, 260, 'I doesn\'t like broccoli.', 0, 1),
(356, 260, 'I don\'t likes broccoli.', 0, 2),
(357, 260, 'I doesn\'t like not broccoli.', 0, 3),
(358, 260, 'I don\'t like broccoli.', 1, 4),
(359, 261, 'Apathy', 0, 1),
(360, 261, 'Joy', 1, 2),
(361, 261, 'Despair', 0, 3),
(362, 261, 'Sorrow', 0, 4),
(363, 262, 'Neither my brother nor I has finished the assignment.', 1, 1),
(364, 262, 'Neither my brother nor I have finished the assignment.', 0, 2),
(365, 262, 'Neither my brother nor I has\'t finished the assignment.', 0, 3),
(366, 262, 'Neither my brother nor I have\'s finished the assignment.', 0, 4);
...
(133, 38, 'TC202507225654', 'English Quiz — Basic Grammar & Vocabulary (Regenerated)', '', NULL, 120, 1, 0, 1, 1, 'published', '2025-08-02 10:14:48', '2025-08-02 10:14:48', 112, '1');
...
(178, 112, 'ST202507239872', '2025-08-02 11:52:57', NULL, 0, 'failed', 'completed', 'Jim Hadjili', 'jim.hadjili@gmail.com', 'grade_12', 'stem', '12345'),
(179, 112, 'ST202507239872', '2025-08-02 11:53:58', NULL, 0, 'failed', 'completed', 'Jim Hadjili', 'jim.hadjili@gmail.com', 'grade_12', 'stem', '12345'),
(180, 112, 'ST202507239872', '2025-08-02 11:54:49', NULL, 0, 'failed', 'completed', 'Jim Hadjili', 'jim.hadjili@gmail.com', 'grade_12', 'stem', '12345'),
(181, 112, 'ST202507239872', '2025-08-02 11:55:34', NULL, 0, 'failed', 'completed', 'Jim Hadjili', 'jim.hadjili@gmail.com', 'grade_12', 'stem', '12345'),
(183, 112, 'ST202507239872', '2025-08-02 12:11:31', NULL, 0, 'failed', 'completed', 'Jim Hadjili', 'jim.hadjili@gmail.com', 'grade_12', 'stem', '12345'),
(184, 112, 'ST202507239872', '2025-08-02 12:14:41', NULL, 0, 'failed', 'completed', 'Jim Hadjili', 'jim.hadjili@gmail.com', 'grade_12', 'stem', '12345');
...
(260, 133, 'multiple-choice', 'Which of the following sentences is grammatically correct?', 1, 1, '2025-08-02 10:14:48', '2025-08-02 10:14:48'),
(261, 133, 'multiple-choice', 'Which word best completes the sentence to form a synonym for \'happiness\'?', 1, 2, '2025-08-02 10:14:48', '2025-08-02 10:14:48'),
(262, 133, 'multiple-choice', 'Which of the following sentences uses the correct subject-verb agreement?', 1, 3, '2025-08-02 10:14:48', '2025-08-02 10:14:48'),
(263, 133, 'short-answer', 'Rewrite the following sentence in the past tense: \'The dog barks.\'', 1, 4, '2025-08-02 10:14:48', '2025-08-02 10:14:48');
...
(627, 178, 172, '123', NULL, 0, 0, '2025-08-02 17:52:57'),
(628, 178, 173, '127', NULL, 0, 0, '2025-08-02 17:52:57'),
(629, 179, 172, '123', NULL, 0, 0, '2025-08-02 17:53:58'),
(630, 179, 173, '127', NULL, 0, 0, '2025-08-02 17:53:58'),
(631, 180, 172, '123', NULL, 0, 0, '2025-08-02 17:54:49'),
(632, 180, 173, '127', NULL, 0, 0, '2025-08-02 17:54:49'),
(633, 181, 172, '123', NULL, 0, 0, '2025-08-02 17:55:34'),
(634, 181, 173, '127', NULL, 0, 0, '2025-08-02 17:55:34'),
(639, 183, 172, '123', NULL, 0, 0, '2025-08-02 18:11:31'),
(640, 183, 173, '127', NULL, 0, 0, '2025-08-02 18:11:31'),
(641, 184, 172, '123', NULL, 0, 0, '2025-08-02 18:14:41'),
(642, 184, 173, '127', NULL, 0, 0, '2025-08-02 18:14:41');
...
--
ALTER TABLE `question_options_tb`
  MODIFY `option_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=367;

--
-- AUTO_INCREMENT for table `quizzes_tb`
--
ALTER TABLE `quizzes_tb`
  MODIFY `quiz_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=134;

--
-- AUTO_INCREMENT for table `quiz_attempts_tb`
--
ALTER TABLE `quiz_attempts_tb`
  MODIFY `attempt_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=185;

--
-- AUTO_INCREMENT for table `quiz_questions_tb`
--
ALTER TABLE `quiz_questions_tb`
  MODIFY `question_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=264;
...
--
ALTER TABLE `student_answers_tb`
  MODIFY `answer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=643;

<div class="bg-white rounded-lg shadow-md border border-gray-200 px-6 py-5 mb-6 flex flex-col md:flex-row gap-5 items-center">
    ...
    <div class="w-full md:w-1/2 relative">
        ...
        <input id="activitySearch" type="text" placeholder="Search by student, class, or quiz..." 
        ...
        <label for="activitySearch" class="text-xs text-gray-500 absolute -top-2 left-2 bg-white px-1">Search Activities</label>
    </div>
    
    <!-- Activity Type Filter Dropdown -->
    <div class="w-full md:w-60 relative">
        <label for="activityTypeFilter" class="text-xs text-gray-500 absolute -top-2 left-2 bg-white px-1">Activity Type</label>
        <select id="activityTypeFilter" class="w-full px-3 py-3 border border-gray-300 rounded-lg appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white transition-all duration-200 shadow-sm">
    ...
    <!-- Reset Button -->
    <button id="resetActivityFilters" class="px-5 py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg transition-all duration-200 flex items-center gap-2 border border-gray-300 shadow-sm hover:shadow">

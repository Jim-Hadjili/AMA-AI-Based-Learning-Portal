    ...
    <?php else: ?>
        ...
        <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <?php foreach ($announcements as $announcement): ?>
                <div class="bg-white shadow-lg rounded-xl overflow-hidden border border-gray-200 hover:shadow-xl hover:border-blue-300 transition-all duration-200 cursor-pointer announcement-card-clickable mb-4"
                    ...
                    <div class="p-6">
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-shrink-0">
                                <div class="w-14 h-14 rounded-xl flex items-center justify-center shadow-sm bg-orange-100">
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="mb-3 flex justify-between items-start">
                                    <h4 class="text-lg font-semibold text-gray-900 mb-1 pr-4 truncate" title="<?php echo htmlspecialchars($announcement['title']); ?>">

        ...
        <div class="flex items-center justify-between">
            <div class="flex space-x-3">
                <a href="../Quiz/editQuiz.php?quiz_id=<?php echo $quiz['quiz_id']; ?>" 
                   class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-blue-600 rounded-lg hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 shadow-sm hover:shadow-md">
            ...
            <div class="relative">
                ...
                <div class="quiz-menu hidden absolute right-0 bottom-full mb-2 w-52 bg-white rounded-xl shadow-xl border border-gray-200 z-20 overflow-hidden">
                    <div class="py-2">
                        ...
                        <button class="open-delete-modal-btn w-full text-left px-4 py-3 text-sm text-red-600 hover:bg-red-50 flex items-center transition-colors duration-200" 
                                data-quiz-id="<?php echo $quiz['quiz_id']; ?>" 
                                data-quiz-title="<?php echo htmlspecialchars($quiz['quiz_title']); ?>">

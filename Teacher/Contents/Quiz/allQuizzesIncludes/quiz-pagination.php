...
<div class="mt-6 flex flex-col items-center">
    ...
    <div class="text-sm text-gray-600 mb-3">
        ...
        <span><?php echo $totalQuizzes; ?> total quiz<?php echo $totalQuizzes != 1 ? 'zes' : ''; ?></span>
    </div>
    ...
    <nav class="inline-flex rounded-xl shadow-sm overflow-hidden" aria-label="Pagination">
        ...
        <div class="hidden md:flex">
            ...
            if ($startPage > 1): ?>
                <a href="<?php echo buildUrl(1); ?>" class="relative inline-flex items-center px-4 py-2.5 border-r border-gray-200 bg-white text-sm font-medium text-gray-700 hover:bg-purple-50 hover:text-purple-700 transition-colors">
                    1
                </a>
                <?php if ($startPage > 2): ?>
            ...
            <?php for ($i = $startPage; $i <= $endPage; $i++): ?>
                ...
                <?php else: ?>
                    <a href="<?php echo buildUrl($i); ?>" class="relative inline-flex items-center px-4 py-2.5 border-r border-gray-200 bg-white text-sm font-medium text-gray-700 hover:bg-purple-50 hover:text-purple-700 transition-colors">
                        <?php echo $i; ?>
                    </a>
                <?php endif; ?>
            <?php endfor; ?>
            ...
            <?php if ($endPage < $totalPages): ?>
                ...
                <?php endif; ?>
                <a href="<?php echo buildUrl($totalPages); ?>" class="relative inline-flex items-center px-4 py-2.5 border-r border-gray-200 bg-white text-sm font-medium text-gray-700 hover:bg-purple-50 hover:text-purple-700 transition-colors">
                    <?php echo $totalPages; ?>
                </a>
            <?php endif; ?>
        </div>

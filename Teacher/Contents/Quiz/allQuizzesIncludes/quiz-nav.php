        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2">
            <li>
                <div class="flex items-center space-x-3">
                    ...
                    <span>Back to <?php echo htmlspecialchars($classInfo['class_name']); ?> Class</span>
                    </a>
                </div>
            </li>
            <li>
                <div class="flex items-center">
                    ...
                    <span class="px-3 py-2 text-gray-900 font-bold bg-gray-200 rounded-xl">
                        <?php echo htmlspecialchars($classInfo['class_name']); ?> All Quizzes
                    </span>
                </div>
            </li>
        </ol>
